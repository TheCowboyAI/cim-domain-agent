...
readonly CANONICAL_COPYRIGHT="Copyright (c) 2025-2026 - Cowboy AI, Inc."
# YEAR RANGE, not a fixed year. The single-year form was RETIRED 2026-08-13 when
# 1,645 files were rewritten off it; this script previously reverted that rewrite.
# MAINTENANCE TRIGGER: needs a second element in 2027 (registered in hatter progress.json).
readonly COPYRIGHT_YEAR="2025-2026"
readonly COPYRIGHT_HOLDER="Cowboy AI, Inc."
...
has_valid_copyright() {
    ...
    case "$ext" in
        "rs")
            # Look for the canonical header (year RANGE — see CANONICAL_COPYRIGHT)
