...
use cim_domain_agent::{
    ...
    aggregate::{Agent, AgentType, AgentMarker},
    value_objects::{AgentId, AgentCapability},
};
use cim_domain::{
    CommandHandler, CommandEnvelope, CommandStatus,
    AggregateRepository, EntityId, MessageIdentity,
